...
import app.repository.mysqlImp.MysqlFriendsGroupRepositoryImpl;
import app.repository.mysqlImp.mappers.FriendsGroupMapper;
...
public class FriendsGroupRepositoryTest {
    ...
    void shouldGetGroupById() {
        ...
        assertThat(group, Matchers.is(expectedGroup));
    }
