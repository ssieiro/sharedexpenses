...
public class DefaultDebtCalculatorTest {
    ...
    public void shouldSettleOneDebtAndTwoFriends(){
        ...
        assertThat(debts, is(List.of(new Debt(friendPaco, friendSonia, BigDecimal.valueOf(10).setScale(2)))));
    }
    ...
    public void shouldSettleOneDebtWithThreeFriends(){
        ...
        assertThat(debts, is(List.of(new Debt(friendPaco, friendSonia, BigDecimal.valueOf(5).setScale(2)),
    ...
    public void shouldSettleDebtsWithDecimals(){
        ...
        assertThat(debts, is(List.of(new Debt(friendPaco, friendAlba, BigDecimal.valueOf(20.20).setScale(2)),
    ...
    public void shouldSettleNotRoundNumbers(){
        ...
        List<Debt> debts = debtCalculator.calculateDebts(List.of(payment), List.of(friendSonia, friendPaco, friendAlba));
        assertThat(debts, is(List.of(new Debt(friendPaco, friendSonia, BigDecimal.valueOf(3.34).setScale(2)),
